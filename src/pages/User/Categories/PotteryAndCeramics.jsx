...
import { getProductsByPotteryandCeramicsApi } from '../../../apis/Api';
import Categories from '../../../components/Categories';

const PotteryAndCeramics = () => {


  const [products, setProducts] = useState([]);
  useEffect(() => {
    getProductsByPotteryandCeramicsApi().then((res) => {
...
export default PotteryAndCeramics

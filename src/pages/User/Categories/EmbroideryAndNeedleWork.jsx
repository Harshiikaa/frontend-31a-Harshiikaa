...
import { getProductsByEmbroideryandNeedleworkApi } from '../../../apis/Api';

const EmbroideryAndNeedleWork = () => {
  
  const [products, setProducts] = useState([]);
  useEffect(() => {
    getProductsByEmbroideryandNeedleworkApi().then((res) => {
...
export default EmbroideryAndNeedleWork
